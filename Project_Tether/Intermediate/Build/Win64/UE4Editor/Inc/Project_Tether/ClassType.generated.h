...
public: \
	DECLARE_CLASS(UPlayerClassType, UDataAsset, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Project_Tether"), NO_API) \
...
#define Project_Tether_Source_Project_Tether_Public_Core_Class_ClassType_h_16_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UPlayerClassType); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UPlayerClassType); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UPlayerClassType(UPlayerClassType&&); \
	NO_API UPlayerClassType(const UPlayerClassType&); \
public:
